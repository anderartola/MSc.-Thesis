...
\begin{figure}
    ...
    \caption{An example observed $\Delta_\tau$ PDF recovered using 450 simualted CDM skewers and its uncertainties in black, plotted against the model CDM PDF, which is the best-fit model in the $\chi^2$ test. }
